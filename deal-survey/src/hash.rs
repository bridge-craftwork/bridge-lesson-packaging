...
mod tests {
    ...
    fn rotations_hash_identically() {
        let deal = Deal::from_pbn(
            "S:94.QJ76.KQ65.AJ6 QJ3.432.A873.T42 A76.A98.JT9.KQ85 KT852.KT5.42.973",
        )
        .unwrap();
        // The same board rotated one seat (the "nonstandard" presentation).
        let rotated = Deal::from_pbn(
            "N:QJ3.432.A873.T42 A76.A98.JT9.KQ85 KT852.KT5.42.973 94.QJ76.KQ65.AJ6",
        )
        .unwrap();
    ...
    fn distinct_deals_hash_differently() {
        ...
        let b = Deal::from_pbn(
            "N:AQJ7.K.Q75.AT942 K843.T542.J6.863 962.AJ7.KT82.J75 T5.Q9863.A943.KQ",
        )
        .unwrap();
